<template>
	<view>
		...
		<view class="content">
			<view v-if="navbarCommunication.topNavber == 0">
				<view v-for="(item, index) in dataResults.results">
					<card
					:activityId="item.id"
					:distribution="false"
			...
			<view v-else-if="navbarCommunication.topNavber == 1">
				<view v-for="(item, index) in dataResults.results">
					<card
					:activityId="item.id"
					:distribution="false"
...
.ivu-tabs-ink-bar {
	...
	.content {
		...
		margin: 74upx auto; 
		// margin: 97.2upx auto;
		// margin-bottom: 97.2upx;
		// margin-left: 97.2upx;
		// margin-right: 97.2upx;
		position: relative;
