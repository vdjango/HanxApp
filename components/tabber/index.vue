<template>
	<view v-if="show" class="u-tabbar u-skeleton" @touchmove.stop.prevent="() => {}">
	
		<view class="u-skeleton u-tabbar__content safe-area-inset-bottom" 
		:style="{height: $u.addUnit(height), backgroundColor: bgColor}">
		
			<view v-if="skeleton">
				<view class="u-skeleton-rect u-tabbar__content__item" :style="{backgroundColor: bgColor}">
					<view class="u-skeleton-circle u-tabbar__content__item__button">
						<u-icon class="u-skeleton-circle" :size="iconSize" name="share"></u-icon>
					</view>
					<view class="u-skeleton-circle u-tabbar__content__item__text">
						<text class="u-skeleton-circle u-line-1 u-font-xs">share</text>
					</view>
				</view>
				<view class="u-skeleton-rect u-tabbar__content__item" :style="{backgroundColor: bgColor}">
					<!-- 微信小程序UI错误，通过custom-style解决微信小程序布局错误问题 -->
					<u-button class="u-skeleton-circle" style="width: 230px;" :custom-style="{width: 'inherit'}" shape="circle" type="primary" :ripple="true" size="medium">???</u-button>
				</view>
			</view>
			...
			<u-skeleton :loading="skeleton" :animation="true" bgColor="#FFF"></u-skeleton>
		</view>
	</view>
</template>
